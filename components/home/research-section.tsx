...
export function ResearchSection() {
  return (
    <section className={`${section} bg-white`} id="ricerca">
      <div className={`${container} grid items-center gap-28 lg:grid-cols-[1fr_0.86fr] max-lg:gap-16 max-md:grid-cols-1`}>
        ...
        <div>
          ...
          <p className="my-8 text-[17px] leading-[1.8] text-muted">
            La ricerca traslazionale è il ponte tra scoperta scientifica e cura: parte dal lavoro
            dei laboratori e punta a trasformare nuove conoscenze in strumenti utili per diagnosi,
