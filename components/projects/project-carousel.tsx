            ...
            >
              ...
              <div className="flex min-h-[330px] flex-1 flex-col p-6 sm:p-7">
                ...
                {linkCards ? (
                  ...
                  <dl className="mt-6 grid gap-5 border-t border-line pt-5 text-sm leading-[1.7]">
                    {project.partner ? (
                      <div>
                        <dt className="text-[10px] font-extrabold uppercase tracking-[0.14em] text-rose">
                          Collaborazione
                        </dt>
                        <dd className="mt-2 text-ink">{project.partner}</dd>
                      </div>
                    ) : null}
                    {project.objective ? (
                      <div>
                        ...
                        <dd className="mt-2 text-muted">{project.objective}</dd>
                      </div>
                    ) : project.excerpt ? (
                      <div>
                        <dt className="sr-only">Descrizione</dt>
                        <dd className="text-muted">{project.excerpt}</dd>
                      </div>
                    ) : null}
                  </dl>
                )}
