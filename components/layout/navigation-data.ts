...
export const navigation: readonly NavigationGroup[] = [
  {
    ...
    children: [
      {
        label: "La nostra associazione",
        href: "/chi-siamo/la-nostra-associazione",
        description: "Storia, missione e valori di A-ROSE.",
      },
      {
        label: "Team scientifico",
        href: "/chi-siamo/team-scientifico",
        description: "Ricercatori, clinici e collaboratori.",
      },
      {
        label: "Partner e sostenitori",
        href: "/chi-siamo/partner-e-sostenitori",
        description: "La rete istituzionale e territoriale.",
      },
      {
        label: "Trasparenza",
        href: "/trasparenza",
  ...
  },
  {
    ...
    children: [
      {
        label: "Cos'è la ricerca traslazionale",
        href: "/la-ricerca/ricerca-traslazionale",
        description: "Il ponte tra scoperta scientifica e cura.",
      },
      {
      ...
      {
        label: "Formazione",
        href: "/la-ricerca/formazione",
        description: "Competenze e crescita per la ricerca.",
      },
      {
        label: "Pubblicazioni e risultati",
        href: "/la-ricerca/pubblicazioni-e-risultati",
        description: "Fonti e risultati del team scientifico.",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        description: "Il ruolo di informazione e consapevolezza.",
      },
      {
        label: "HPV e tumore cervicale",
        href: "/prevenzione/hpv-e-tumore-cervicale",
        description: "Una pagina informativa in aggiornamento.",
      },
      {
        label: "Screening e controlli",
        href: "/prevenzione/screening-e-controlli",
        description: "Risorse per comprendere i percorsi di screening.",
      },
      {
        label: "Guide e approfondimenti",
        href: "/prevenzione/guide-e-approfondimenti",
        description: "Articoli e materiali divulgativi.",
      },
      {
        label: "FAQ",
    ...
    children: [
      {
        ...
        description: "Sostieni direttamente la ricerca.",
      },
      {
        label: "5×1000",
