...
export const metadata: Metadata = {
  ...
  description: "Articoli A-ROSE dedicati alla prevenzione oncologica e alla consapevolezza.",
};
  ...
  return (
    <NewsCategoryPage
      ...
      filter={(category) => {
        ...
        return normalizedCategory.includes("prevenzione") || normalizedCategory.includes("consapevolezza");
      }}
    />
  );
}
